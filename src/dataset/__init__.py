...
from .dataset_scannet import DatasetScannet, DatasetScannetCfgWrapper
...
DatasetCfgWrapper = DatasetDL3DVCfgWrapper | DatasetScannetppCfgWrapper | DatasetCo3dCfgWrapper | DatasetScannetCfgWrapper
